function [ file_path, folder_path, file_name, name, ext ] = GetFilePath()
%GETFILEPATH Get file path
%   Asks the user to select a file via a uigetfile window.
%   Returns the full file path, as well as the folder path, file name
%   and extension in separate variables.
%
%   At the end of the function, the created variables contain the following:
%   * file_path: Contains the full path to the file.
%     Example: /home/einar/Documents/git/master/SummaryPlotter/test_data/rslts_ECL_ECLak_gefac.mat
